...
cp -R "${SCRIPTPATH}/DetoxRecorder/Build/Products/Release-iphonesimulator/DetoxRecorder.framework" "${SCRIPTPATH}/Distribution"
...
cp "${SCRIPTPATH}/DetoxRecorder/Build/Products/Release/DetoxRecorderCLI" "${SCRIPTPATH}/Distribution"
